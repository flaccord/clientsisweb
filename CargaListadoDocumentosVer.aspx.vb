...
Partial Class CargaListadoDocumentosVer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		rfc.Text = Request.QueryString("rfc")
		cliente.Text = Request.QueryString("cliente")
    ...
    Private Sub CargarYMostrarImagen(ByVal version As String)
        ...
        Try
            ...
            ds = objConexíon.EjecutarConsultaSQL("Select Ruta From Docs_Digitaliza_Ref Where IDReferencia = '" & Request.QueryString("IDRef") & "' And IDDocumento = '" & DataGrid1.SelectedItem.Cells(4).Text & "' And Version = '" & version & "'")
            ...
            Else
                strScript = "<script language=" & Chr(34) & "javascript" & Chr(34) & ">" & Chr(10) & Chr(13)
                strScript &= " window.parent.document.imgLoadN.src = 'http://64.182.79.210/clientsiswebprod/images/no-image-available.png';" & Chr(10) & Chr(13)
                strScript &= "</script>" & Chr(10) & Chr(13)
                ClientScript.RegisterClientScriptBlock(Me.GetType(), "FileAttach" & value, strScript)
            End If
        Catch ex As Exception
